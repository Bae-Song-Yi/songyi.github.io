import {
  ...
  LOAD_NOTICE_REQUEST,
  LOAD_NOTICE_SUCCESS,
} from '../reducers/auctionConsts';

import { biddingInsertReqType } from '../type';
...
export const likeWorkSuccess = (lot_num: number) => ({
...
export const setLanguageRequest = (data: string) => ({
  type: 'auction/SET_LANGUAGE',
  data,
});
...
export type ActionRequest =
  ...
  | ReturnType<typeof setLanguageRequest>;
